...
$usertype="Nurse";
$msg="Insert New Daily Examination Details of In Patients";
...
if(isset($_SESSION['panel']) && $_SESSION['panel']=="NO") {
    ...
    if (isset($_POST['Submit'])) {
        if (isset($_SESSION['record']) && $_SESSION['record'] == 'NO') {
            ...
            $sql = "INSERT INTO `inpatient_daily_examination`( `Patient_ID`, `Emp_No`, `Date`, `Time`, `Temp`, `Weight`, `Blood_Pres`, `Pulse`) VALUES ('$Patient_ID','$Emp_No','$Date','$Time','$Temp','$Weight','$Blood_Pres','$Pulse')";
...
<form method="POST" action="insert1.php">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="blood_press" placeholder="BloodPressure(Hg/mm)" required>
        </div>
    </div><br>
    <div class="form-group row">
